...
<div id="productModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 max-w-2xl w-full shadow-lg relative"> <!-- Increased max-width to 3xl -->
...
<script>
    ...
    <footer class="p-4 bg-gray-200 mt-6">
        <p class="text-center text-gray-600">© 2025 <a href="https://fb.com/khmerpos2" class="text-blue-500 hover:underline">Simple POS</a> All rights reserved.</p>
    </footer>
